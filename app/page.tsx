  ...
  return (
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      <div className="space-y-2 pt-5 pb-8 md:space-x-5">
        <h1
          className="text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-13 animate-fade-in"
        >
          Home
        </h1>
      </div>
      ...
      <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:gap-y-0">
        <div className="flex flex-col items-center pt-8 xl:sticky xl:top-8 animate-slide-in-left">
          ...
          <div className="flex space-x-5 pt-6">
            <a href="https://github.com/diwakarcs50" target="_blank" aria-label="GitHub" className="transform hover:scale-110 transition-all duration-200">
              <svg
            ...
            <a href="https://www.linkedin.com/in/diwakar-kumar25/" target="_blank" aria-label="LinkedIn" className="transform hover:scale-110 transition-all duration-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            <a href="mailto:diwakar2506agrawal@gmail.com" aria-label="Email" className="transform hover:scale-110 transition-all duration-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            <a href="https://x.com/Diwakar78798330" target="_blank" aria-label="Twitter" className="transform hover:scale-110 transition-all duration-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
